...
class C3k_EFEM(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(EFEM(c_, c_) for _ in range(n)))
...
class EFEConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k_EFEM(self.c, self.c, 2, shortcut, g) if c3k else EFEM(self.c, self.c) for _ in range(n))
